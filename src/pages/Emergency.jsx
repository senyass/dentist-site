    ...
    return (
        <div className="mt-45 text-center">
            <div className="max-w-4xl mx-auto">
                ...
                <p className='p-2'>If you are experiencing severe tooth pain, a broken tooth, swelling, or a dental injury, contact us immediately.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 w-[80%] max-w-4xl mx-auto my-10">
                <div className="bg-alice-blue p-10 rounded-lg shadow-md shadow-charcoal/20 flex flex-col items-center justify-between min-h-[350px]">
                    <div>
                        ...
                        <p className="text-emergency-red-hover/80 font-medium">Recommended for immediate care</p>
                    </div>

                    <button className="mt-3 px-6 py-3 bg-charcoal text-white rounded-lg hover:bg-charcoal/80"> <CallIcon className="mr-2 scale-110 -translate-y-[1px]" /> Call Now  </button>
                </div>
                ...
                <div className="bg-alice-blue p-10 rounded-lg shadow-md shadow-charcoal/20 flex flex-col items-center justify-between min-h-[350px]">
                    <div>
                        ...
                        <p className="text-emergency-red-hover/80 font-medium">Available 24/7 for urgent dental care</p>
                    </div>
